#MenuTitle: Sync Numerators
# -*- coding: utf-8 -*-
__doc__="""

Syncs metrics and kerning groups of Numerators, and creates missing .numr glyphs
...
def transformNodes( thisLayer , sf ):
	...
	offset=Font.selectedFontMaster.capHeight-Font.selectedFontMaster.capHeight * sf
...
def syncSelected():
	...
	for thisLayer in selectedLayers:
		...
		if thisLayer.parent.category=="Number": # if selected glyph is a number
			...
			if suffixOffset>0:
				supName = sourceGlyphName[:suffixOffset]+".numr"
			else:
				supName =sourceGlyphName+".numr"
			kernName=".numr"
