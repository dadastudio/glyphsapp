...
Kern Questions Exclams Periods Ellipsis
...
for thisMaster in Font.masters:
	...
	dotOffset=getComp(questionLayer,"period").position.x
	exclamDotOffset=getComp(exclamLayer,"period").position.x
