#MenuTitle: Position anchor under the node
# -*- coding: utf-8 -*-
__doc__="""
Position anchor under the node respecting italic angle or any given
"""
...
def moveCallback(sender):
	...
	try:
		...
		if selection.count() == 1:
			s=selection[0]
			selectedLayer.anchors[GetAnchorNames()[w.anchor_name.get()]].x=getItalic(s.x,-s.y, float(w.angle_text.get()))
		else:
